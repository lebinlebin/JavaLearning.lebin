package Java.lebin.Training.ObjectOriented.day8EncapsulationPackage.demo3;
/**
 * 此类用于演示可变参数的方法
 * 概念：jdk5.0出现的新特性。将同一个类中，多个方法名相同、参数类型相同、返回类型相同，仅仅是参数个数不同的方法抽取成一个方法，这种方法称为可变参数的方法
 * 
 * 好处：提高代码的重用性和维护性
 * 
 * 语法：
